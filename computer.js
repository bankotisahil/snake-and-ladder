...
const diceFaces = [
  ...
  function rollDice() {
    rollingSound.play(); // Play sound on every roll
...
document.getElementById("diceBtn").addEventListener("click", function () {
    ...
    // Disable button while turn plays out
    ...
    document.getElementById('goat').innerText = "Computer's Turn...";
    play('p1', 'p1sum', 0, num);

    // Computer plays after 2 seconds
    setTimeout(() => {
        rollDice();
        let compNum = dicenumber;
        play('p2', 'p2sum', 55, compNum);

        document.getElementById('goat').innerText = "Your Turn!";
